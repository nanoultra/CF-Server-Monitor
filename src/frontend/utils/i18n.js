...
const translations = reactive({
  en: {
    ...
    displayModeTip: 'Default dashboard view for visitors who have not selected a local view.',
  ...
  zh: {
    ...
    displayModeRing: '环形图',
    displayModeTable: '列表',
    displayModeTip: '未手动切换过视图的访客，会默认使用这里设置的首页展示方式。',
    displayOptions: '显示选项',
    publicAccess: '公开访问',
    showPrice: '显示价格',
    showExpire: '显示到期时间',
    ...
    telegramToken: 'Telegram / 企业微信 / 飞书 / Bark / Server酱 / WxPusher / Gotify',
    chatId: '聊天 ID',
    saveConfig: '保存配置',
    saving: '保存中...',
    hostnameLabel: '主机名',
    ...
    jwtSettings: 'JWT 设置',
    jwtSecret: 'JWT 密钥',
    jwtSecretPlaceholder: '至少32个字符,留空表示不修改当前密钥',
    monthlyTraffic: '月度流量',
    ...
    disableOfflineNotifyDesc: '跳过离线告警通知',
